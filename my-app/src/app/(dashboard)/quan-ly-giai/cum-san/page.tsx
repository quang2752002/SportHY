          ...
          <CardBody className="p-4">
            ...
            <div className="d-flex flex-wrap justify-content-between align-items-center gap-3 pb-3 mb-4 border-bottom">
              ...
              <div className="d-flex gap-2">
                <Link href="/quan-ly-giai/san-dau" className="btn btn-outline-secondary px-3 py-2 fw-semibold rounded-3 d-inline-flex align-items-center gap-2">
                      ...
                      <tr key={item.id}>
                        ...
                        <td className="text-end">
                          <div className="d-flex justify-content-end gap-1">
                            <Link
                              href={`/quan-ly-giai/san-dau?cumSanId=${item.id}`}
